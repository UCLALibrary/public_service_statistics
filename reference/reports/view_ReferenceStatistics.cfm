<CFQUERY NAME="GetReferenceStatistics" DATASOURCE="#CircStatsDSN#" cachedwithin="#CreateTimeSpan(0,0,360,0)#">
SELECT * FROM view_ReferenceStatistics
WHERE UnitID = 'COL-00'
ORDER BY Created_DT DESC
</CFQUERY>

<CFQUERY NAME="GetServicePointTotal" DATASOURCE="#CircStatsDSN#" cachedwithin="#CreateTimeSpan(0,0,360,0)#">
...
<CFQUERY NAME="GetQuestionTypeTotal" DATASOURCE="#CircStatsDSN#" cachedwithin="#CreateTimeSpan(0,0,360,0)#">
SELECT SUM([Count]) AS Total,
       QuestionType
FROM View_ReferenceStatistics
WHERE UnitID = 'COL-00'
...
<CFQUERY NAME="GetModeTotal" DATASOURCE="#CircStatsDSN#" cachedwithin="#CreateTimeSpan(0,0,360,0)#">
SELECT SUM([Count]) AS Total,
       Mode
FROM View_ReferenceStatistics
WHERE UnitID = 'COL-00'
