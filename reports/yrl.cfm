...
<html>
<head>
	<title>UCLA Library Statistics Summary Report: <cfoutput>#GetUnit.Title#</cfoutput></title>
...
<h1>Statistics Summary Report: <cfoutput>#GetUnit.Title#</cfoutput> <sup><a href="#footnote">*</a></sup></h1>
...
<cfoutput query="GetManualGroup5">
...
<!--- telephone service --->
<tr valign="top" bgcolor="#CCCCCC">
	<td colspan="9" class="small"><b>Telephone service</b></td>
</tr>
<cfoutput query="GetManualGroup10">
<cfif Title IS NOT "TOTAL">
<tr valign="top" bgcolor="##EBF0F7"><td class="small">#Title#</td>
    <td align="right" class="small"><cfif PrevFY IS NOT ''>#NumberFormat(PrevFY, "_,___,___")#<cfelse>NA</cfif></td>
    <td align="right" class="small"><cfif PrevFY IS NOT ''>#NumberFormat(CurrFY, "_,___,___")#<cfelse>NA</cfif></td>
