...
<cfif Action IS "Identify">
	<cfoutput query="GetUser" group="LogonID">
<table border="0"
       cellspacing="1"
       cellpadding="1">
<tr valign="bottom">
...
<tr valign="bottom">
	...
	<td class="copy">
	<cfset i = 1><cfoutput><cfif i GT 1>; </cfif>#Unit#<cfset i = i + 1></cfoutput>
...
<cfmail to="#GetUser.EmailAddress#" from="#SenderEmail#" subject="Circulation Statistics">To: #GetUser.FirstName# #GetUser.LastName#:
